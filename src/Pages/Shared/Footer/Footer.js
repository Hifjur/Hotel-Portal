      ...
      <Container>
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid item xs={12} sm={6}>
            <Typography sx={{ paddingY: 4 }} variant="h4">
              Contact us!
            </Typography>
            <Grid
              container
            ...
            >
              <Grid direction="column" align="left" item xs={6}>
                <FacebookOutlined sx={{ marginX: 1 }} /> @HotelPortal
              </Grid>
              <Grid direction="column" align="left" item xs={6}>
                <Twitter sx={{ marginX: 1 }} /> @HotelPortal
              </Grid>
              <Grid direction="column" align="left" item xs={6}>
                <EmailOutlined sx={{ marginX: 1 }} /> Hotel@Portal.com
              </Grid>
              <Grid direction="column" align="left" item xs={6}>
        ...
        <Typography variant="subtitle1">Hotel Reservation Portal.</Typography>
        <Typography variant="subtitle1">
          Copyright all right reserved <CopyrightOutlined />
        </Typography>
      </Container>
    </div>
  );
